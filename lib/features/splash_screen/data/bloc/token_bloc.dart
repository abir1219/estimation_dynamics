...
class TokenBloc extends Bloc<TokenEvent, TokenState> {
  ...
  FutureOr<void> _fetchTokenData(FetchTokenData event,Emitter<TokenState> emit) async{
    ...
    FormData body = FormData.fromMap({
      'grant_type': ConstantVariable.grant_type,//'client_credentials',
      'client_id': ConstantVariable.client_id,//'e7db77ef-e2a5-4aea-9257-3db5bcfb76d5',
      'client_secret': ConstantVariable.client_secret,//'Js~8Q~9Sx39gnjrOCan.SIp4LdpKij1cY2-gicpu',
